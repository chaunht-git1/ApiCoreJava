...
public class DoitacList implements Serializable {
    ...
    @Size(max = 1)
    @Column(name = "GIAOPHIEU_WEB")
    private String giaophieuWeb;
    @Size(max = 1)
    @Column(name = "IMPORT_WEB")
    private String importWeb;
    @Size(max = 1)
    @Column(name = "IMPORT_API")
    private String importApi;
    @Basic(optional = false)
    @NotNull
    @Size(min = 1, max = 1)
    @Column(name = "XM_KHONGDAU")
    private String xmKhongdau;
    @Size(max = 10)
    @Column(name = "XM_LAN")
    private String xmLan;
    ...
    public String getXmKhongdau() {
        return xmKhongdau;
    }

    public void setXmKhongdau(String xmKhongdau) {
        this.xmKhongdau = xmKhongdau;
    }

    public String getXmLan() {
        return xmLan;
    }

    public void setXmLan(String xmLan) {
        this.xmLan = xmLan;
    }
